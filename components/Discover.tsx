...
const Discover = () => {
  ...
  //how can we know if a specific item is clicked
  //well for that we can use the data that's inside of our url
  //and to get that data we can use the next router
